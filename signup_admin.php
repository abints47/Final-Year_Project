...
<head>
    ...
    <title>Admin Sign Up - Openly</title>
...
<body class="min-h-screen flex flex-col overflow-x-hidden selection:bg-rose-500/30 bg-[#020617]">
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div class="aura bg-rose-600 w-[500px] h-[500px] top-0 left-0 -translate-x-1/2 -translate-y-1/2 opacity-20">
        </div>
        <div class="aura bg-orange-600 w-[500px] h-[500px] bottom-0 right-0 translate-x-1/2 translate-y-1/2 opacity-20">
        </div>
    </div>
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto flex flex-col items-center justify-center px-6 py-20">
        <div class="w-full max-w-md relative">
            <div class="text-center mb-10">
                <span class="text-xs font-bold text-rose-400 uppercase tracking-widest mb-2 block">Control Center</span>
                <h1 class="text-3xl font-black text-white mb-2 tracking-tight">Join as an <span
                        class="gradient-cyan">Admin</span></h1>
                <p class="text-slate-400 text-sm">Oversee and manage the entire platform.</p>
            </div>
            ...
            <div class="glass p-10 rounded-[2.5rem] shadow-2xl">
                <form action="signup_admin.php" method="POST" class="space-y-6">
                    <div>
                    ...
                    <div>
                        <input name="email" type="email" required placeholder="Admin Email Address"
                            class="input-field w-full bg-[#0f172a] border border-white/10 rounded-2xl px-5 py-4 text-white placeholder:text-slate-600 focus:outline-none" />
                    </div>
                    <div>
                    ...
                    <button type="submit"
                        class="w-full gradient-btn text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-rose-500/20 transition-all hover:opacity-90 active:scale-[0.98]">
                ...
                <div class="mt-8 pt-8 border-t border-white/5 text-center">
                    <p class="text-slate-400 text-sm">
                        ...
                        <a href="signup_teacher.php"
                            class="text-indigo-400 font-bold hover:text-indigo-300 transition-colors">Teacher Signup</a>
                    </p>
                </div>
            </div>
        </div>
