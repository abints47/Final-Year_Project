    ...
    <main class="max-w-7xl mx-auto px-6 py-12 w-full relative z-10 flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1 space-y-12">
            ...
            <div class="space-y-6">
                ...
                <!-- Course Stats -->
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 p-6 glass rounded-2xl">
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest">Instructor</p>
                        <p class="text-sm font-semibold text-white">
                            <?php echo htmlspecialchars($course['author']); ?>
                        </p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest">Rating</p>
                    ...
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest">Students</p>
                        <p class="text-sm font-semibold text-white">
                            <?php echo htmlspecialchars($course['students']); ?>
                        </p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest">Modules</p>
                        <p class="text-sm font-semibold text-white">
            ...
            <!-- Detailed Summary -->
            <section class="space-y-6">
                <h2 class="text-3xl font-bold text-white">Course Description</h2>
        ...
        <div class="lg:w-96 space-y-6">
            <div class="glass p-8 rounded-[2.5rem] sticky top-32 space-y-8">
