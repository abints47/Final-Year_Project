...
<body class="min-h-screen flex flex-col pt-24">
    ...
    <main class="max-w-7xl mx-auto px-6 py-12 w-full relative z-10">
        ...
        <div class="mb-12">
            ...
            <p class="text-slate-400 text-base md:text-lg">Discover courses that will take your skills to the next level
            </p>
        </div>

        <!-- Search & Filter Bar -->
        <div class="glass rounded-3xl p-6 md:p-8 mb-12 shadow-2xl">
            <form action="courses.php" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <!-- Search -->
                <div class="space-y-2">
                    <label class="text-xs font-bold text-slate-400 uppercase tracking-widest pl-1">Search</label>
                    <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"
                        placeholder="Search courses..."
                        class="w-full bg-[#020617] border border-white/10 rounded-xl px-5 py-3 text-white placeholder:text-slate-600 focus:outline-none focus:border-cyan-500/50 transition-colors text-sm" />
                </div>
...
=======
                    <div class="relative">
                        <select name="category" onchange="this.form.submit()"
                            ...
                            <option value="All" <?php echo $category === 'All' ? 'selected' : ''; ?>>All Categories
                            </option>
                            <option value="Programming" <?php echo $category === 'Programming' ? 'selected' : ''; ?>>
                                Programming</option>
                            <option value="Web Dev" <?php echo $category === 'Web Dev' ? 'selected' : ''; ?>>Web
                                Development</option>
                            <option value="AI/ML" <?php echo $category === 'AI/ML' ? 'selected' : ''; ?>>AI & Machine
                                Learning</option>
                            <option value="Security" <?php echo $category === 'Security' ? 'selected' : ''; ?>>Cyber
                                Security</option>
                            <option value="Cloud" <?php echo $category === 'Cloud' ? 'selected' : ''; ?>>Cloud Computing
                            </option>
                            <option value="Data Science" <?php echo $category === 'Data Science' ? 'selected' : ''; ?>>
                                Data Science</option>
                            <option value="Mobile Dev" <?php echo $category === 'Mobile Dev' ? 'selected' : ''; ?>>Mobile
                                Development</option>
                        </select>
...
>>>>>>> ea85590 (Implement Interview Prep section: quiz, landing page, and data)
        ...
        <!-- Results Info -->
        <div class="mb-8">
            <p class="text-slate-400 font-medium tracking-wide">Showing <span
                    class="text-white font-bold"><?php echo count($filtered_courses); ?></span> courses</p>
        </div>
                ...
                <?php foreach ($filtered_courses as $course): ?>
                    <a href="course_detail.php?id=<?php echo $course['id']; ?>"
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            ...
                            <p class="text-slate-500 text-sm mb-6 font-medium">by <span
                                    class="text-slate-300"><?php echo $course['author']; ?></span></p>
                            ...
                            <div class="flex items-center gap-6 mt-auto pt-6 border-t border-white/5">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span class="text-sm font-bold text-white"><?php echo $course['rating']; ?></span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span class="text-sm font-semibold text-slate-400"><?php echo $course['students']; ?></span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <svg class="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <span
                                        class="text-sm font-semibold text-slate-400 text-nowrap"><?php echo $course['duration']; ?></span>
                                </div>
                            </div>
                        </div>
                    </a>
