...
<head>
    ...
    <title>Student Sign Up - Openly</title>
...
<body class="min-h-screen flex flex-col overflow-x-hidden selection:bg-indigo-500/30 bg-[#020617]">
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div class="aura bg-indigo-600 w-[500px] h-[500px] top-0 left-0 -translate-x-1/2 -translate-y-1/2 opacity-20">
        </div>
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto flex flex-col items-center justify-center px-6 py-20">
        <div class="w-full max-w-md relative">
            <div class="text-center mb-10">
                <span class="text-xs font-bold text-indigo-400 uppercase tracking-widest mb-2 block">Learning
                    Center</span>
                <h1 class="text-3xl font-black text-white mb-2 tracking-tight">Join as a <span
                        class="gradient-cyan">Student</span></h1>
                <p class="text-slate-400 text-sm">Start your journey to master new skills today.</p>
            </div>
            ...
            <div class="glass p-10 rounded-[2.5rem] shadow-2xl">
                <form action="signup_student.php" method="POST" class="space-y-6">
                    <div>
                    ...
                    <div>
                        <input name="email" type="email" required placeholder="Student Email Address"
                            class="input-field w-full bg-[#0f172a] border border-white/10 rounded-2xl px-5 py-4 text-white placeholder:text-slate-600 focus:outline-none" />
                    </div>
                    <div>
                    ...
                    <button type="submit"
                        class="w-full gradient-btn text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-indigo-500/20 transition-all hover:opacity-90 active:scale-[0.98]">
                ...
                <div class="mt-8 pt-8 border-t border-white/5 text-center">
                    <p class="text-slate-400 text-sm">
                        ...
                        <a href="signup_teacher.php"
                            class="text-emerald-400 font-bold hover:text-emerald-300 transition-colors">Teacher
                            Signup</a>
                        <span class="mx-2 text-slate-600">|</span>
                        <a href="signup_admin.php"
                            class="text-rose-400 font-bold hover:text-rose-300 transition-colors">Admin Signup</a>
                    </p>
                </div>
            </div>
        </div>
